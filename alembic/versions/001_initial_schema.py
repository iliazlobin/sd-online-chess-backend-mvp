...
def upgrade() -> None:
    op.create_table(
        "players",
        sa.Column("player_id", sa.Uuid(), nullable=False, server_default=sa.text("gen_random_uuid()")),
        sa.Column("token", sa.Text(), nullable=False, server_default=sa.text("gen_random_uuid()::text")),
    ...
    op.create_table(
        "games",
        sa.Column("game_id", sa.Uuid(), nullable=False, server_default=sa.text("gen_random_uuid()")),
